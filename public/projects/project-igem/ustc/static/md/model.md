...
# 1.1 Objective
![Figure 1.1：How to optimize the tail structure of the α-factor generated by botulinum toxin cleavage？](https://static.igem.wiki/teams/5924/drylab/tail.webp)
...
![Figure 1.2: CataPro for predicting enzyme kinetic parameters of enzymatic reactions.(Wang et al, 2025)](https://static.igem.wiki/teams/5924/drylab/catapro.webp)
...
![Figure 1.3 Docking results of BoNT/A with SNAP-25 variants.1: Wild-type protein. 2: Deletion of residue 202. 3: Deletion of 201-202. 4: Deletion of 200-202. 5: Deletion of 199-202. A lower score indicates higher potential cleavage efficiency.](https://static.igem.wiki/teams/5924/drylab/snap-25.webp)



![Figure 1.4 Docking results of cleavage products with Ste2 receptor. Labels correspond to the variants in Figure 1.3. These are the docking results of the different cleavage products with the Ste2 receptor protein. A lower score indicates stronger binding affinity. 6 is the control group, measuring the binding affinity between alpha-factor and the Ste2 receptor.](https://static.igem.wiki/teams/5924/drylab/ste2.webp)
...
[2]Wang, Z., Xie, D., Wu, D., Luo, X., Wang, S., Li, Y., Yang, Y., Li, W., & Zheng, L. (2025). Robust enzyme discovery and engineering with deep learning using CataPro. Nature communications, 16(1), 2736. 
...
![Figure 2.1 Protein structures displayed by PyMol. From left to right: the Pir1p-SNAP25-α-factor fusion protein (predicted by Alphafold2), the α-factor-bound Ste2 (PDB:7QA8), and the ligand-free Ste2 (PDB:7QB9).](https://static.igem.wiki/teams/5924/drylab/molecular.webp)
...
![Figure 2.4 Visualization. The fusion protein and the ste2 were painted cyan.](https://static.igem.wiki/teams/5924/drylab/movie-final.webp)
...
![Figure 3.2 Cultivation Stage :The simulation process throughout the cultivation stage](https://static.igem.wiki/teams/5924/drylab/cultivation-stage.webp)
...
![Figure 3.3 The gene expression during the recovery phase](https://static.igem.wiki/teams/5924/drylab/resuscitation-stage.webp)
...
[5]Tyagi, N.; Gidlöf, Z.; Osanlóo, D.T.; Collier, E.S.; Kadekar, S.; Ringstad, L.; Fureby, A.M.; Roos, S. The Impact of Formulation and Freeze Drying on the Properties and Performance of Freeze-Dried Limosilactobacillus reuteri R2LC. Appl. Microbiol. 2023, 3, 1370-1387. 
...
[10]Pelechano, V., Chávez, S., & Pérez-Ortín, J. E. (2010). A complete set of nascent transcription rates for yeast genes. PLOS ONE, 5(11), e15442. 

[11]Y. Wang, C.L. Liu, J.D. Storey, R.J. Tibshirani, D. Herschlag, & P.O. Brown, Precision and functional specificity in mRNA decay, Proc. Natl. Acad. Sci. U.S.A. 99 (9) 5860-5865,

[12]Pfeffer, M., Maurer, M., Köllensperger, G. et al. Modeling and measuring intracellular fluxes of secreted recombinant protein in Pichia pastoris with a novel 34S labeling procedure. Microb Cell Fact 10, 47 (2011). 
...
[18]Mahbuba H. Meem, Paul J. Cullen, The impact of protein glycosylation on Flo11-dependent adherence in Saccharomyces cerevisiae, FEMS Yeast Research, Volume 12, Issue 7, November 2012, Pages 809–818, 
...
![Figure 4.1 Schematic diagram of the signal transduction and amplification process induced by botulinum toxin cleavage.](https://static.igem.wiki/teams/5924/drylab/graph-demo-2.webp)
...
[https://2025.igem.wiki/ustc/static/html/interactionPlatform.html](https://2025.igem.wiki/ustc/static/html/interactionPlatform.html)
...
+ ^Analysis of the Deterministic DDE Model^
    ...
    ![Figure 4.7 BoNT/A-Signal Response Cure at different concentration off BoNT/A](https://static.igem.wiki/teams/5924/drylab/bonta-dose-response-curve-28800s-ration-1-18to9.webp)
    ...
    ![Figure 4.8 BoNT/A-Signal Response Cure at different concentration off BoNT/A](https://static.igem.wiki/teams/5924/drylab/bonta-dose-response-curve-28800-ration-1-18to-3.webp)
    ...
    ![Figure 4.9 BoNT/A-Signal Response Cure at different concentration off BoNT/A](https://static.igem.wiki/teams/5924/drylab/bonta-dose-response-28800s-ration-1-18-8.webp)
...
+ ^Stochastic Process Analysis and Calculation of LOD/LOQ^
    ...
    ![Figure 4.11 LOD/LOQ of BoNT/A vs. proportion of Substrate-acting Strain and Signal-transferring Strain ($tration\_cell$) at $t$ = 28800 s.](https://static.igem.wiki/teams/5924/drylab/lod-loq-ration-cell-3.webp)
...
+ ^Single Parameter Sensitivity Analysis^
    ...
    ![Figure 4.12 Signal parameter sensitivity analysis for betaxanthins concentration (equal to betaxanthins absorbance) at different set of times and variations of each parameter.](https://static.igem.wiki/teams/5924/drylab/single-parameter-sensitivity-analysis.webp)
    ...
    - At 2.0h, 4.0h, and 8.0h under different parameter variation rates, the types of positively and negatively correlated parameters are basically constant. However, the α-factor degradation half-life $half-life-alphafactor$ shows a phenomenon of negative correlation in the short term and positive correlation in the long term, but the specific cause of this change needs further exploration and discussion. Currently, there is no good conclusion, and this will be our next task.
...
+ ^Global Parameter Sensitivity Analysis^
    ...
    ![Figure 4.13 Global Sensitivity Analysis of Parameters](https://static.igem.wiki/teams/5924/drylab/global-sensitivity-analysis.webp)

    ![Figure 4.14 Heatmap of each two parameters' interactions(Only represent the top5 key parameters)](https://static.igem.wiki/teams/5924/drylab/heatmap-of-parameter-interaction.webp)

    ![Figure 4.15 The dynamic change of parameters Sensitivity over time(Start from about t = 2h because after that the system is fully activated.)](https://static.igem.wiki/teams/5924/drylab/dynamic-change-of-parameter-sensitivity.webp)

    ![Figure 4.16 Paramter Sensitivity Concontribution Analysis (Direct effect vs. Interaction effect)](https://static.igem.wiki/teams/5924/drylab/parameter-sensitivity-contribution.webp)
...
[1] V. Iyer, & K. Struhl, Absolute mRNA levels and transcriptional initiation rates in Saccharomyces cerevisiae., Proc. Natl. Acad. Sci. U.S.A. 93 (11) 5208-5212, (1996).

[2]  Yi, H. Kitano, & M.I. Simon, A quantitative characterization of the yeast heterotrimeric G protein cycle, Proc. Natl. Acad. Sci. U.S.A. 100 (19) 10764-10769, (2003).

[3] Sherman F. (2002). Getting started with yeast. Methods in enzymology, 350, 3–41.

[4] [PIR1 | SGD]

[5] Fan, C., He, N., & Yuan, J. (2024). Cascaded amplifying circuit enables sensitive detection of fungal pathogens. Biosensors and Bioelectronics, 250, 116058, 

[6] Chou YC, Shih CI, Chiang CC, Hsu CH, Yeh YC. Reagent-free DOPA-dioxygenase colorimetric biosensor for selective detection of L-DOPA. Sensors and Actuators B: Chemical. 2019 Oct 15;297:126717. 

[7] Mizanur RM, Stafford RG, Ahmed SA (2014) Cleavage of SNAP25 and Its Shorter Versions by the Protease Domain of Serotype A Botulinum Neurotoxin. PLoS ONE 9(4): e95188. 

[8] calculated by protparam 

[9] Puay Yen Yap and Dieter Trau, Tip Biosystems Pte Ltd, Singapore

[10] Hsu, C., Scherrer, S., Buetti-Dinh, A. et al. Stochastic signalling rewires the interaction map of a multiple feedback network during yeast evolution. Nat Commun 3, 682 (2012). 

[11] [NanoDrop™ One/OneC Microvolume UV-Vis Spectrophotometer ND OneC Spec, no Wi-Fi | Request for Quote]

[12] Girod, PA., Zryd, JP. Secondary metabolism in cultured red beet (Beta vulgaris L.) cells: Differential regulation of betaxanthin and betacyanin biosynthesis. Plant Cell Tiss Organ Cult 25, 1–12 (1991). 

[13] Gao, X., Lanz, M., Grosely, R., Cremer, J., Puglisi, J., & Skotheim, J. M. (2025). Yeast growth is controlled by the proportional scaling of mRNA and ribosome concentrations. *arXiv preprint arXiv:2508.14997.*, 

[14] [DOD - 4,5-DOPA dioxygenase extradiol - Mirabilis jalapa (Garden four-o'clock) | UniProtKB | UniProt]

[15] Y. Arava, Y. Wang, J.D. Storey, C.L. Liu, P.O. Brown, & D. Herschlag, Genome-wide analysis of mRNA translation profiles in Saccharomyces cerevisiae, Proc. Natl. Acad. Sci. U.S.A. 100 (7) 3889-3894, (2003).

[16] Contreras-Llano LE, Guerrero-Rubio MA, Lozada-Ramírez JD, García-Carmona F, Gandía-Herrero F. 2019. First Betalain-Producing Bacteria Break the Exclusive Presence of the Pigments in the Plant Kingdom. mBio 10:10.1128/mbio.00345-19. 

[17] Chan, L. Y., Mugler, C. F., Heinrich, S., Vallotton, P., & Weis, K. (2018). Non-invasive measurement of mRNA decay reveals translation initiation as the major determinant of mRNA stability. Elife, 7, e32536,
...
[19] Steinbrecht, D., Minia, I., Milek, M., Meisig, J., Blüthgen, N., & Landthaler, M. (2024). Subcellular mRNA kinetic modeling reveals nuclear retention as rate-limiting. Molecular Systems Biology, 20(12), 1346-1371

[20] Cruz, S., Checa, N., Tovar, H., Cejudo-Bastante, M. J., Heredia, F. J., & Hurtado, N. (2024). Semisynthesis of Betaxanthins from Purified Betacyanin of Opuntia dillenii sp.: Color Stability and Antiradical Capacity. Molecules, 29(9), 2116. 

[21]Lamphier, M. S., & Ptashne, M. (1992). Multiple mechanisms mediate glucose repression of the yeast GAL1 gene. *Proceedings of the National Academy of Sciences*, *89*(13), 5922-5926.

[22]Rodríguez-Sánchez, J. A., y Victoria, M. T. C., & Barragán-Huerta, B. E. (2017). Betaxanthins and antioxidant capacity in Stenocereus pruinosus: Stability and use in food. *Food Research International*, *91*, 63-71,
...
Therefore, we constructed ^three^ mathematical models to explore how the Substrate-acting Strain-to-Signal-transferring Strain ratio influences α-factor distribution and receptor activation.^Since the quantities of the two strains in the initial system have reached to maximum , Model 1 and Model 2 did not consider the competition during yeast reproduction in the model.^ By quantitatively describing the balance between α-factor production, diffusion, and uptake, our model aims to identify the optimal ratio that maximizes signaling efficiency. This provides both a theoretical explanation for the experimental observations and guidance for adjusting proportions in the wet lab.
...
|$K_m$ |Michaelis constant of SNAP-25 cleavage by BoNT|1.62±0.6 |$μM$ | [1] |
...
![Figure 5.1 The result of the first model shows that the signal increases with the increase in signal-transferring strain fraction.](https://static.igem.wiki/teams/5924/drylab/ra1.webp)
...
![Figure 5.2 The relationship between the highest absorbance and the proportion of signal-transferring strain in the entire strain](https://static.igem.wiki/teams/5924/drylab/rat2.webp)
...
![Figure 5.3 The relationship between botulinum toxin concentration and signal absorbance for different strain ratios.](https://static.igem.wiki/teams/5924/drylab/qujian.webp)
...
| :-------- | :------------- | :-------------- |
| $[U]$ | Concentration of upstream strain (substrate-acting strain) | $f · C_{tot} · p$  |
...
![Figure 5.4 The best ratio for signal amplification in the third model is 1:1 (substrate-reacting strain: signal transferring strain).](https://static.igem.wiki/teams/5924/drylab/ode-ratio.webp)
