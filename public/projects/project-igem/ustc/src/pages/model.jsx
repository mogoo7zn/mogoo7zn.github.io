...
// 动态导入 Markdown
const ModelMd = dynamic(() => import('../md/model.md'), { ssr: false });

const ModelPage = ({ pageData: initialPageData }) => {
...
export async function getStaticProps() {
  const filePath = path.join(process.cwd(), 'static', 'data', 'dry-lab', 'model.json');
...
// 使用 Layout 包裹
ModelPage.getLayout = function getLayout(page, pageProps) {
  return <Layout {...pageProps}>{page}</Layout>;
};

// 页面配置
ModelPage.layoutOptions = {
  showGrid: false,
};
