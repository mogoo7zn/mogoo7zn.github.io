...
const SafetyMd = dynamic(() => import('../md/safety.md'), { ssr: false });
...
export async function getStaticProps() {
  const filePath = path.join(process.cwd(), 'static', 'data', 'project', 'safety.json');
...
SafetyPage.getLayout = function getLayout(page, pageProps) {
  return <Layout {...pageProps}>{page}</Layout>;
};

SafetyPage.layoutOptions = {
