...
const ImplementationMd = dynamic(() => import('../md/implementation.md'), { ssr: false });

const ImplementationPage = ({ pageData : initialPageData }) => {
...
export async function getStaticProps() {
  const filePath = path.join(process.cwd(), 'static', 'data', 'project', 'implementation.json');
...
ImplementationPage.getLayout = function getLayout(page, pageProps) {
  return <Layout {...pageProps}>{page}</Layout>;
};

ImplementationPage.layoutOptions = {
