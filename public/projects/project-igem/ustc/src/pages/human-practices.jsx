...
const HumanPracticesMd = dynamic(() => import('../md/human-practices.md'), { ssr: false });

const HumanPracticesPage = ({ pageData:initialPageData }) => {
...
HumanPracticesPage.getLayout = function getLayout(page, pageProps) {
  return <Layout {...pageProps}>{page}</Layout>;
};

HumanPracticesPage.layoutOptions = {
