...
const ContributionMd = dynamic(() => import('../md/contribution.md'), { ssr: false });

const ContributionPage = () => {
  const initialPageData = {
    title: 'Contribution',
    description: 'Significant part improvements',
    sections: [],
  };
...
export async function getStaticProps() {
  const filePath = path.join(process.cwd(), 'static', 'data', 'project', 'contribution.json');
...
ContributionPage.getLayout = function getLayout(page, pageProps) {
  return <Layout {...pageProps}>{page}</Layout>;
};

ContributionPage.layoutOptions = {
