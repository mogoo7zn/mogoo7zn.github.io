...
const EducationMd = dynamic(() => import('../md/education.md'), { ssr: false });

const EducationPage = () => {
  const initialPageData = {
    title: 'Education',
    description: 'Engaging with students and the public to share our science and foster a passion for synthetic biology.',
    sections: [],
  };
...
export async function getStaticProps() {
  const filePath = path.join(process.cwd(), 'static', 'data', 'human-practices', 'education.json');
...
EducationPage.getLayout = function getLayout(page, pageProps) {
  return <Layout {...pageProps}>{page}</Layout>;
};

EducationPage.layoutOptions = {
