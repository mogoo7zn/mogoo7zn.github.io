...
const ProofofConceptMd = dynamic(() => import('../md/proof-of-concept.md'), { ssr: false });

const ProofofConcept = () => {
  const initialPageData = {
    title: 'Proof of Concept',
    description: 'Our proof of concept work.',
    sections: [],
  };
...
export async function getStaticProps() {
  const filePath = path.join(process.cwd(), 'static', 'data', 'wet-lab', 'proofofconcept.json');
...
ProofofConcept.getLayout = function getLayout(page, pageProps) {
  return <Layout {...pageProps}>{page}</Layout>;
};

ProofofConcept.layoutOptions = {
