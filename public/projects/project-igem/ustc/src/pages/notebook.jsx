...
const NotebookMd = dynamic(() => import('../md/notebook.md'), { ssr: false });

const NotebookPage = () => {
  const initialPageData = {
    title: 'Notebook',
    description: "A day-by-day log of our team's progress, challenges, and findings.",
    sections: [],
  };
...
NotebookPage.getLayout = function getLayout(page, pageProps) {
  return <Layout {...pageProps}>{page}</Layout>;
};

NotebookPage.layoutOptions = {
