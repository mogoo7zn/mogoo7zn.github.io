...
const ResultsMd = dynamic(() => import('../md/results.md'), { ssr: false });
...
export async function getStaticProps() {
  const filePath = path.join(process.cwd(), 'static', 'data', 'wet-lab', 'results.json');
...
ResultsPage.getLayout = function getLayout(page, pageProps) {
  return <Layout {...pageProps}>{page}</Layout>;
};

ResultsPage.layoutOptions = {
