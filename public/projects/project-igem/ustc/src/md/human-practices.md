...
^2.Food Safety Awareness and Behavior^
...
+ ^1. Review from the Director of the Laboratory in a Food Processing Enterprise^
...
+ ^2.Review from the Person in Charge of a Third-Party Testing Institution^
...
+ ^3.Reviews from Respondents of All Age Groups in Society^
...
+ ^A. Fast-Food Enterprise – Qingsong Food^
...
+ ^ B. Testing Institution – Guotai Zhongxin^
...
+ ^C.Fermented Food Enterprise – Huangshan Huiweixian Food Co., Ltd.^
...
+ ^D. The Conference themed synthetic biology and consumer goods ^
    ...
    ^2.In terms of the implementation^
...
# A. CCiC(Conference of China iGEMer Community)
...
# B. Live Biotherapeutic Products Conference in Peking University
