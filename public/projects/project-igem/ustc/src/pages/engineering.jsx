...
import EngineeringPageLayout from '../components/layout/EngineeringPageLayout/EngineeringPageLayout';
import heading_styles from '../components/layout/ContentPageLayout/ContentPageLayout.module.scss';

const EngineeringMd = dynamic(() => import('../md/engineering.md'), { ssr: false });

const EngineeringPage = ({ pageData:initialPageData }) => {
...
export async function getStaticProps() {
  const filePath = path.join(process.cwd(), 'static', 'data', 'project', 'engineering.json');
...
EngineeringPage.getLayout = function getLayout(page, pageProps) {
  return <Layout {...pageProps}>{page}</Layout>;
};

EngineeringPage.layoutOptions = {
