...
const HardwarePage = ({ pageData:initialPageData }) => {
...
export async function getStaticProps() {
  const filePath = path.join(process.cwd(), 'static', 'data', 'dry-lab', 'hardware.json');
...
HardwarePage.getLayout = function getLayout(page, pageProps) {
  return <Layout {...pageProps}>{page}</Layout>;
};

HardwarePage.layoutOptions = {
